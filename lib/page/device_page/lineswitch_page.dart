...
class LineSwitchPage extends StatefulWidget {
  const LineSwitchPage({Key? key}) : super(key: key);

  @override
  State<LineSwitchPage> createState() => _LineSwitchPageState();
}

class _LineSwitchPageState extends State<LineSwitchPage> {
  bool status1 = true;
  Widget appbar(size) {
